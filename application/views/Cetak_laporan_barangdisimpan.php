...
<meta charset="UTF-8">
  ...
  <title>Data Barang Disimpan</title>
...
<center><h1>Data Barang Disimpan</h1></center>
    <?= form_open_multipart('data_barang/cetak_laporan_barangdisimpan')?>
            <h4>Filter Tanggal Barang Disimpan</h4>
            <div class="row">
    ...
    <table id="table" class="table table-striped table-bordered">
        <thead>
            <tr>
                <th>NO</th>
                <th>NAMA BARANG</th>
                <th>TANGGAL INPUT PENYIMPANAN</th>
                <th>TANGGAL BARANG DISIMPAN</th>
    ...
    <tbody>
        <?php
            $no = 1;
            foreach($tb_barangdisimpan as $brg): ?>

            <tr>
                <td><?= $no++?></td>
                <td><?= $brg->nama_barang?></td>
                <td><?= $brg->tanggal_input_penyimpanan?></td>
